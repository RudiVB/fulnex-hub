...
const PARTS = [
  ...
  { key: "doorbar2", label: "Door B (AAA)", file: "/hardware/flx-door-2-bar.stl" },
  { key: "doorback2", label: "Door B back", file: "/hardware/flx-door-2-back.stl" },
  { key: "motion", label: "Motion", file: "/hardware/flx-motion-1-shell.stl" },
  { key: "petvisor", label: "Pet visor", file: "/hardware/flx-motion-1-mask.stl" },
